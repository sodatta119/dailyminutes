...
class AgentTaskSummaryRepositoryTest {
    ...
    void testSaveAndFindAgentTaskSummary() {
        AgentEntity agent1 = agentRepository.save(new AgentEntity(null, "Agent Alpha", AgentState.ACTIVE, 10l, "8787879879", "A001", LocalDate.now(), null, AgentDesignation.FLEET_AGENT, "99L", LocalDateTime.now(), false, Double.valueOf(1d), Double.valueOf(1d), 1, 1,100)); // Updated
    ...
    void testFindByAgentId() {
        AgentEntity agent1 = agentRepository.save(new AgentEntity(null, "Agent Alpha", AgentState.ACTIVE, 10l, "8787879879", "A001", LocalDate.now(), null, AgentDesignation.FLEET_AGENT, "99L", LocalDateTime.now(), false, Double.valueOf(1d), Double.valueOf(1d), 1, 1,100)); // Updated
        AgentEntity agent2 = agentRepository.save(new AgentEntity(null, "Agent Beta", AgentState.ACTIVE, 10l, "9876543210", "A002", LocalDate.now(), null, AgentDesignation.FLEET_AGENT, "999L", LocalDateTime.now(), false, Double.valueOf(1d), Double.valueOf(1d), 1, 1,100)); // Updated
    ...
    void testFindByTaskStatus() {
        ...
        AgentEntity agent1 = agentRepository.save(new AgentEntity(null, "Agent Alpha", AgentState.ACTIVE, 10l, "876876868", "A003", LocalDate.now(), null, AgentDesignation.FLEET_AGENT, "99L", LocalDateTime.now(), false, Double.valueOf(1d), Double.valueOf(1d), 1, 1,100)); // Updated
        AgentEntity agent2 = agentRepository.save(new AgentEntity(null, "Agent Beta", AgentState.ACTIVE, 10l, "987987987", "A004", LocalDate.now(), null, AgentDesignation.FLEET_AGENT, "999L", LocalDateTime.now(), false, Double.valueOf(1d), Double.valueOf(1d), 1, 1,100)); // Updated
        AgentEntity agent3 = agentRepository.save(new AgentEntity(null, "Agent Sigma", AgentState.ACTIVE, 10l, "9878768766", "A005", LocalDate.now(), null, AgentDesignation.FLEET_AGENT, "9999L", LocalDateTime.now(), false, Double.valueOf(1d), Double.valueOf(1d), 1, 1,100)); // Updated
