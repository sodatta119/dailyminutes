...
@EnableJdbcRepositories(basePackages = {"com.dailyminutes.laundry.agent.repository", "com.dailyminutes.laundry.task.repository", "com.dailyminutes.laundry.team.repository", "com.dailyminutes.laundry.store.repository", "com.dailyminutes.laundry.customer.repository", "com.dailyminutes.laundry.order.repository"})
@ComponentScan(basePackages = {"com.dailyminutes.laundry.agent.domain.model", "com.dailyminutes.laundry.task.domain.model", "com.dailyminutes.laundry.team.domain.model", "com.dailyminutes.laundry.store.domain.model", "com.dailyminutes.laundry.customer.domain.model", "com.dailyminutes.laundry.order.domain.model"})
