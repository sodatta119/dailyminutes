...
class StoreRepositoryTest {
    ...
    void testFindByManagerId() {
        storeRepository.save(new StoreEntity(null, "Manager Store X", "Address X", "555", "x@example.com", 20l));
        storeRepository.save(new StoreEntity(null, "Manager Store Y", "Address Y", "666", "y@example.com", 20l));
