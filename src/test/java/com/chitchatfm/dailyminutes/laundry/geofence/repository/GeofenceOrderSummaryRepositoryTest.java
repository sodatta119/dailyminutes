...
@EnableJdbcRepositories(basePackages = {"com.chitchatfm.dailyminutes.laundry.geofence.repository",
...
@ComponentScan(basePackages = {"com.chitchatfm.dailyminutes.laundry.geofence.domain.model",
