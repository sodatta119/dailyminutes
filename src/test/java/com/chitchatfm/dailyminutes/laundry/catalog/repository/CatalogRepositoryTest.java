...
@EnableJdbcRepositories(basePackages = "com.chitchatfm.dailyminutes.laundry.catalog.repository") // Specify repository package
@ComponentScan(basePackages = "com.chitchatfm.dailyminutes.laundry.catalog.domain.model") // Specify domain model package
